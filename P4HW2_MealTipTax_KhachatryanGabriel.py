...
def tipCalculator():
    # To keep calculations visually seperated print #s before each calculation
    print("------------------------------------------------------------------")
...
while keep_going.lower() == 'y':
    tipCalculator()
    keep_going = input('Would you like to calculate tip for another amount (Enter "Y" if so)? ')
